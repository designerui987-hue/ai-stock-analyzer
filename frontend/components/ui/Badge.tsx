...
export interface BadgeProps extends React.HTMLAttributes<HTMLSpanElement> {
  variant?: 'emerald' | 'red' | 'amber' | 'indigo' | 'neutral' | 'slate' | 'buy' | 'sell' | 'hold';
  size?: 'sm' | 'md';
}
...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const variantStyles = {
    ...
    slate: 'bg-slate-100 dark:bg-slate-800/80 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-white/5',
